            ...
            <div class="widget-content widget-content-area">
                <div class="table-responsive">
                    <table class="table table-bordered mb-4">
                        <tbody>
                        <tr>
                            <td class="label-table"> {{ __('messages.order_code') }}</td>
                            <td>
                                {{$data->id}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="label-table"> {{ __('messages.customer_name') }}</td>
                            <td>
                                {{ $data->name }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="label-table"> {{ __('messages.sub_total') }} </td>
                            <td>
                                <h5>{{ $data->sub_total }} {{ __('messages.egy_bound') }}</h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-table"> {{ __('messages.discount_cost') }} </td>
                            <td>
                                <h5>{{ $data->shipping }} {{ __('messages.egy_bound') }}</h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-table"> {{ __('messages.discount') }} </td>
                            <td>
                                <h5>{{ $data->discount }} {{ __('messages.egy_bound') }}</h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-table"> {{ __('messages.total_bill') }} </td>
                            <td>
                                <h5>{{ $data->total }} {{ __('messages.egy_bound') }}</h5>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference5">
                                            <a class="dropdown-item"
                                               href="{{route('orders.change.status',['status'=> 'accept','id'=>$data->id])}}"
                                               style="color: #2196f3; text-align: center;">{{ __('messages.accept_order') }}</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item"
                                               href="{{route('orders.change.status',['status'=> 'execution','id'=>$data->id])}}"
                                               style="color: #f5b455; text-align: center;">{{ __('messages.make_it') }}</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item"
                                               href="{{route('orders.change.status',['status'=> 'arrived','id'=>$data->id])}}"
                                               style="color: green; text-align: center;">{{ __('messages.arrived') }}</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item"
                                               href="{{route('orders.change.status',['status'=> 'rejected','id'=>$data->id])}}"
